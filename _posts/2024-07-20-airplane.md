...
# المقدمة
بسم الله الرحمن الرحيم، هذا التحدي الجميل من غرفة [Airplane](https://tryhackme.com/r/room/airplane) ، نبدأ بثغرة LFI بعدين نحاول نطلع معلومات عن الخدمات الموجودة على السيرفر عشان نقدر نحصل اتصال عكسي reverse shell. نصيحة: لاتشوف حل أي تحدي إلا بعد أن تبذل قصارى جهدك وتستنفذ جميع الحلول اللي عندك، إذا شفت مقال زي هذا، شوف حل المشكلة اللي علقت عندها فقط.
...
إذا حاولنا نستخدم أدوات زي ffuf & gobuster راح نحصل بعنوان airplane/ الصفحة مافيها شيء فلذلك ماراح أضيع وقتي فيها.<br>
